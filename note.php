...
if (isset($_SESSION['note_insert_errors'])) {
    ...
    <div class="container">
        <div class="sidebar">
            <img src="img/notelogo.png" alt="ar">
              <ul>
                  <li onclick="searchNotes('allNotes')" id="allNotes">All Notes</li>
                  <li onclick="searchNotes('favorites')" id="favorites">Favorites</li>
                  <li  onclick="searchNotes('archives')" id="archives">Archives</li>
    ...
    <form action="include/edit_user.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" id="originalUserName" value="<?php echo htmlspecialchars($_SESSION['user_name']); ?>">

        <input type="text" id="userName" name="userName" value="<?php echo isset($_SESSION['submitted_values']['userName']) ? htmlspecialchars($_SESSION['submitted_values']['userName']) : htmlspecialchars($_SESSION['user_name']); ?>">
        <?php if (isset($_SESSION['errors']['userName'])) { echo '<div class="error">' . $_SESSION['errors']['userName'] . '</div>'; } ?>
        <label for="userPhoto">Photo:</label>
        <input type="file" id="userPhoto" name="userPhoto" accept="image/*" onchange="previewImage(event)"><br><br>
        <div id="preview-container">
                <img id="preview" src="#" alt="Preview Image">
            </div><br><br>
        <button type="submit" onclick="return validateChanges()">Save Changes</button>
    </form>
</div>
...
<script>
    function previewImage(event) {
        ...
        <div class="left">
          ...
          <input type="text" id="searchInput" oninput="searchNotes('allNotes')" placeholder="Search...">
    ...
    <button id="addNoteBtn">Add Note</button>
            ...
            <div style="display: none; color:aliceblue; font-size:30px; text-align:center;" id="noResultsMessage">No Search Found</div>
